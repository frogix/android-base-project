...
public class ScheduleActivity extends AppCompatActivity {
    ...
    static public String ARG_NAME = "0";
    static public String ARG_ID = "1";
    static public String ARG_TYPE = "2";
    static public String ARG_MODE = "3";
    static public String ARG_TIME = "4";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Date givenTime = (Date) getIntent().getSerializableExtra(ARG_TIME);
